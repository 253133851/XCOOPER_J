...
/**
 * Created by sunsai on 2015/9/10.
 */
public class AuthFilter implements Filter {

    private static final long CHECK_OPERATOR_TIME = 60*60*1000;//��¼60�����޲�����������¼��Ϣ,���µ�¼
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if((now - last) > CHECK_OPERATOR_TIME) {
            res.sendRedirect("../../ui/login.jsp");
            return;
        }else if(StrUtil.isNull(type) || (!"admin".equals(type) && !"xuefei".equals(type))){
            res.sendRedirect("../../ui/forbidden.jsp");
            return;
        } else {
