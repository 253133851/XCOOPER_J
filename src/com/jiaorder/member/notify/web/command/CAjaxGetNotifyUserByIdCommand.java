 ...
 */
public class CAjaxGetNotifyUserByIdCommand implements Command {

    @Override
    public String execute(RequestHelper helper, HttpServletRequest request) throws ServletException, BusinessRuleException, DataAccessException, SysException {
        //加入page格式
        NotifyUserBean bean = NotifyUserBean.newInstance();
        Page<NotifyUserVO> page = new Page<>();
        page.setItems(bean.getNotifyUserByNID(serviceId, notifyId));
        //日志记录
