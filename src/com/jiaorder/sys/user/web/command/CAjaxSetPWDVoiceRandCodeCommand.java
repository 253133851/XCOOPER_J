 ...
 */
public class CAjaxSetPWDVoiceRandCodeCommand implements Command {
    ...
    public String execute(RequestHelper requesthelper, HttpServletRequest request) throws ServletException,BusinessRuleException, DataAccessException {
        ...
        Object randomStrObj = session.getAttribute("resetPwdValidateCode");
        ...
        //发送语音验证码
        VoiceCheckCodeUtil.sendVoiceCheckCode(request.getParameter("RESET_MOBILE"), randomStr, "3");
