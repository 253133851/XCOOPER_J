    ...
    public Collection getTaskColl(String sql, boolean isFocus) throws DataAccessException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                VO.setEND_DATETIME(MysqlDialect.TimestampFormat(rs.getTimestamp("END_DATETIME")));    //END_DATETIME
                VO.setTASK_INFO(rs.getString("TASK_INFO"));    //TASK_INFO
                VO.setIS_DEL(rs.getInt("IS_DEL"));    //IS_DEL
                VO.setADD_DATETIME(MysqlDialect.TimestampFormat(rs.getTimestamp("ADD_DATETIME")));    //ADD_DATETIME
                VO.setUPDATE_DATETIME(MysqlDialect.TimestampFormat(rs.getTimestamp("UPDATE_DATETIME")));    //UPDATE_DATETIME
                VO.setDEL_DATETIME(MysqlDialect.TimestampFormat(rs.getTimestamp("DEL_DATETIME")));    //DEL_DATETIME
                if (isFocus) {
